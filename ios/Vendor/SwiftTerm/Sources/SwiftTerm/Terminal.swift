...
//                break
    ...
    public func scroll (isWrapped: Bool = false)
    {
        ...
        if hasNarrowMargins {
            ...
            // Match iTerm2's `useScrollbackWithRegion`: tmux often reserves a
            // status row, so preserve the line leaving its partial scrolling
            // region instead of discarding it.
            if hasScrollback {
