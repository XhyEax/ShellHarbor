...
/// Allows user-authentication algorithms such as RFC 8332 RSA-SHA2 to use an
/// algorithm identifier that differs from the public-key blob identifier.
public protocol NIOSSHUserAuthenticationKeyProtocol {
    var userAuthenticationAlgorithmPrefix: String { get }
    var userAuthenticationBlobPrefix: String { get }
}
